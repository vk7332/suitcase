...
const InvoiceForm = ({ existingInvoice = null, onSuccess }: InvoiceFormProps) => {
    ...
    useEffect(() => {
        const taxable = parseFloat(String(formData.taxable_amount)) || 0;
        const gstPercent = formData.is_gst_applicable
            ? parseFloat(String(formData.gst_percentage)) || 0
            : 0;
